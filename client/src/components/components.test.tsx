...
describe('ProductsFilter', () => {
  it('offers translated product types and restores the saved filter from localStorage', () => {
    window.localStorage.setItem('inventory:product-filters', JSON.stringify({ type: 'Laptops', specification: '' }));
    ...
    expect(store.getState().products.filters.type).toBe('Laptops');
